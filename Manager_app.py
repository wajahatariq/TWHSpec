...
total_charge = filtered_df["Charge"].sum()
avg_charge = round(filtered_df["Charge"].mean(), 2) if total_txns > 0 else 0
...
Only mention general trends, issues, or data quality insights — no detailed rows.
"""
